...
<div class="d-flex justify-content-center my-4">
	<input type="button" value="결제하기" onclick="confirmPayment('${room_code}','${arrival_Date}', '${rsv_totalpay}')">
</div>

</div>

<script type="text/javascript">
function confirmPayment(room_code,arrival_Date,rsv_totalpay) {
    if (confirm("결제를 진행하시겠습니까? (장바구니에 담은 상품은 삭제됩니다)")) {
    	window.location.href = "/payment/paymentForm?room_code=" + room_code + "&arrival_Date=" + arrival_Date + "&rsv_totalpay=" + rsv_totalpay;
  }
}
</script>
<!-- 수정(2023-06-29) 끝 -->
