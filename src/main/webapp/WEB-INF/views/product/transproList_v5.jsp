	 ...
	 <table>
	  ...
	  <tr>
		...
		<th style="text-align: center">
			<input type="button" class="btn btn-primary" value="검색" onclick="location.href='depCodeSelect?departure_Date=${departure_Date}&arrival_code=${arrival_code}&departure_code=${departure_code}'" >
		</th>
	  </tr>	
	 </table>
	</div>
